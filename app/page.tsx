  ...
  return (
    <div className="relative bg-[#0A0A0A] text-[#E8E5E0]">
      ...
      <div className="relative z-10">
        <section aria-hidden="true" className="min-h-[calc(100vh-5rem)] md:min-h-[calc(100vh-5.5rem)]" />
          ...
          <div className="container py-16">
            <FoldSection index={1} preset="aggressive" className="fold-cascade">
              <div className="chat-materialize panel rounded-3xl px-6 py-8 md:px-8 md:py-10">
                <div>
                  <p className="text-xs uppercase tracking-[0.24em] text-[#C45A3C]">Margin Notes — 01</p>
                  <h2 className="font-display mt-2 text-5xl leading-none md:text-6xl">Ask The Margin</h2>
                  <p className="mt-4 max-w-xl text-sm text-[#d2ccc3]">Alpha lives in the margins.</p>
                </div>
                <div className="mt-6">
                  <ChatbotWidget />
                </div>
          ...
          <FoldSection index={2} preset="aggressive" className="fold-cascade">
            <div>
              <div className="mb-5">
                ...
                <h2 className="font-display mt-2 text-5xl leading-none md:text-6xl">Signal</h2>
              </div>
